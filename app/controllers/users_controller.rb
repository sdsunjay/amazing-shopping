class UsersController < ApplicationController
  ...
  def show
    ...
    @pagy_products, @products = pagy(Product.includes(:inventories).where(user_id: @user).order(created_at: :desc), page_param: :page_products, params: { active_tab: 'products-tab' })
  ...
  def user_params
    ...
    accessible = %i[name email shop_name card_brand card_last_four shop_domain]
